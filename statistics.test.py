import unittest
import math
from statistics import calculateStats1
...
class StatsTest(unittest.TestCase):
  def test_report_min_max_avg(self):
    ...
    epsilon = 0.001
    print ('avg:',computedStats["avg"])
    print ('max:',computedStats["max"])
    print ('min:',computedStats["min"])
  ...
  def test_avg_is_nan_for_empty_input(self):
    computedStats = calculateStats([1.5,9,3.2])
#    print('max1:',computedStats["max"])
    x=math.isnan(computedStats)
    print(x)
